...
public class SupermarketInventory {
    ...
    //Every picture used in the inventory
    ...
    public void saveToFile() throws IOException {
        ...
        if (YesNo == 0) {
            ...
            {
                array[0][j] = i[j - 1];
                if (j == i.length - 1) break; //Makes sure not to include the "Actions" button in the display file
            }
            ...
            for (int j = 0; j < array[1].length; j++) writer.print(array[1][j] + " ");
            ...
            for (int j = 0; j < array[2].length; j++) writer.print(array[2][j] + " ");
            ...
            writer.println();
            for (Object o : i) writer.print(o + "#");

            writer.println();
            for (Object o : l) writer.print(o + "#");

            writer.println();
            for (Object o : km) writer.print(o + "#");
    ...
    public void specialSaveToFile() throws IOException {
        ...
        if (YesNo == 0) {
            ...
            for (int j = 0; j < 3; j++) {
                for (int k = 0; k < array[j].length; k++) writer.print(array[j][k] + " ");
                writer.println();
            }
    ...
    public void loadData() throws IOException {
        ...
        //Saved list from text file
            ...
            for (int i = 0; i < 3; i++) array[i] = fileReader.readLine();
            ...
            else item = new ArrayList<>(Arrays.asList(i2));
    ...
    public static void login(Login login) {
        ...
        if (!login.passwordTextField.getText().equals("password")) {
            ...
            if (lockedOut < 5) {
                ...
                if (lockedOut == 3) JOptionPane.showMessageDialog(login, "Hint: The password starts with a p");
                else JOptionPane.showMessageDialog(login, "Error! Wrong password. Please try again.");
                ...
                //Add an item to the inventory
                    ...
                    do {
                        ...
                        do
                        {
                            ...
                            if(k1.equalsIgnoreCase("Actions")) JOptionPane.showMessageDialog(null,"You can't add \"Actions\" button.");

                            else if(item.contains(k1)) JOptionPane.showMessageDialog(null,"Two items can't have the same name.","Error!",JOptionPane.INFORMATION_MESSAGE,null);

                            else if(!k1.matches("[a-zA-Z\\s]*")) JOptionPane.showMessageDialog(null,"The name of an item cannot have any numbers or special characters.","Error!",JOptionPane.INFORMATION_MESSAGE,null);
                        ...
                        if (k1 == null) {
                            ...
                            if (cancel == 0) break;
                            else if (cancel == 1) continue;


                        }

                        else k1 = k1.replaceAll("\\s+", " ");
